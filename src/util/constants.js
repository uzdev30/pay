...
import { BsShieldFillCheck, BsFillSendFill, BsDropbox } from "react-icons/bs";
...
export const feedback = [
  ...
  },
  {
    id: 2,
    content:
      "Money makes  your life easier.If you are lucky to have it,you're lucky.",
    name: "Steve Mark",
    title: "Founder & Leader",
  },
  {
...
export const clients = [
  {
    ...
    title: "AIRBNB",
    logo: (
      <FaAirbnb className="sm:w-[50px] w-[40px] sm:h-[50px] object-contain icons mr-3 h-[40px]" />
    ),
  },
  {
    id: 2,
    title: "BINANCE",
    logo: (
      <TbBrandBinance className="sm:w-[50px] w-[40px] sm:h-[50px] object-contain icons mr-3 h-[40px]" />
    ),
  },
  {
    id: 3,
    title: "COINBASE",
    logo: (
      <TbBrandCoinbase className="sm:w-[50px] w-[40px] sm:h-[50px] object-contain icons mr-3 h-[40px]" />
    ),
  },
  {
    id: 4,
    title: "DROPBOX",
    logo: (
      <BsDropbox className="sm:w-[50px] w-[40px] sm:h-[50px] object-contain icons mr-3 h-[40px]" />
    ),
  },
];
